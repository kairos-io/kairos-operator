...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *NameOverrideSpec) DeepCopyInto(out *NameOverrideSpec) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new NameOverrideSpec.
func (in *NameOverrideSpec) DeepCopy() *NameOverrideSpec {
	if in == nil {
		return nil
	}
	out := new(NameOverrideSpec)
	in.DeepCopyInto(out)
	return out
}
...
func (in *OSArtifactSpec) DeepCopyInto(out *OSArtifactSpec) {
	*out = *in
	...
	out.NameOverride = in.NameOverride
}
...
func (in *ResourcesSpec) DeepCopyInto(out *ResourcesSpec) {
	*out = *in
	...
	if in.CloudImage != nil {
		in, out := &in.CloudImage, &out.CloudImage
		*out = new(v1.ResourceRequirements)
		(*in).DeepCopyInto(*out)
	}
	if in.AzureImage != nil {
		in, out := &in.AzureImage, &out.AzureImage
		*out = new(v1.ResourceRequirements)
		(*in).DeepCopyInto(*out)
	}
	if in.GCEImage != nil {
		in, out := &in.GCEImage, &out.GCEImage
		*out = new(v1.ResourceRequirements)
		(*in).DeepCopyInto(*out)
	}
	if in.Netboot != nil {
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *UKISpec) DeepCopyInto(out *UKISpec) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new UKISpec.
func (in *UKISpec) DeepCopy() *UKISpec {
	if in == nil {
		return nil
	}
	out := new(UKISpec)
